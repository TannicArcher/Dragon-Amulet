...
require_once ( 'config.dat' ); // настройки игры
...
// MENU
$stmp .= "</p></card><card id=\"m\" title=\"Меню\">
          <p><a href=\"$PHP_SELF?sid=$sid&cs=$(to)\">Говорить/Взять</a><br/>
          <a href=\"$PHP_SELF?sid=$sid&ca=$(to)\">Атаковать</a>";
$b = "<br/>";
...
$stmp .= '<br/><a href="' . $PHP_SELF . '?sid=' . $sid . '&transfer=$(to)&list=inv">Передать</a>';
